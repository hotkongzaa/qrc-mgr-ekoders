...
<html>
        ...
        <script type="text/javascript">
            ...
            function editUser() {
                ...
                if (row) {
                    ...
                    $('#fm').form('load', row);
                    url = 'update_member_role.php?id=' + row.role_id;
                }
            }
            function saveUser() {
                $('#fm').form('submit', {
            ...
            function removeUser() {
                ...
                if (row) {
                    $.messager.confirm('Confirm', 'Are you sure you want to remove this Role?', function(r) {
                        if (r) {
                            $.post('remove_member_role.php', {id: row.role_id}, function(result) {
                                if (result.success) {
                                    $('#dg').datagrid('reload');	// reload the user data
                                } else {
    ...
    <body>
        <h2>Manage Member Role</h2>
        <div class="demo-info" style="margin-bottom:10px"><a href="../index-setting.php">back(กลับ)</a>
        </div>

        <table id="dg" title="Member role" class="easyui-datagrid" style="width:700px;height:400px"
            ...
            <thead>
                <tr>
                    ...
                    <th field="role_name" width="50">Role Name</th>
                </tr>
            </thead>
        </table>
        <div id="toolbar">
        ...
        <div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
            ...
            <div class="ftitle">Member Role Information</div>
