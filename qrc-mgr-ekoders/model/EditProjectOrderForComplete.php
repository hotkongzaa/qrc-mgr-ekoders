...
$sqlUpdateProjectById = "UPDATE QRC_PROJECT_ORDER"
        . " SET COMPLETE_DATE='" . date("Y-m-d H:i:s", strtotime($complete_date)) . "',WO_PERC_OF_PO='$perc_po_price',WO_PRICE='$wo_price',project_status='$project_order_status',updated_date_time=NOW(),remark='$project_order_remark',assign_id=null,po_inspection_id='$inspectionID'"
