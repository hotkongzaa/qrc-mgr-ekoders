...
$sqlCheckDuplicatePOID = "select count(*) as checkCount from QRC_PROJECT_ORDER WHERE image_name like '$project_image_path';";
$resultSetCheck = mysql_query($sqlCheckDuplicatePOID);
$rowResultCheck = mysql_fetch_assoc($resultSetCheck);
if ($rowResultCheck['checkCount'] >= 1) {
    echo 'This PO already create work order (WO)';
} else {
