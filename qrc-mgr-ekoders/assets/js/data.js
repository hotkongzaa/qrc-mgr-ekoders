...
(function (g) {
    ...
    g.extend(n.prototype, {init: function (a, b) {
            ...
            c && jQuery.ajax({dataType: "json",
                url: "https://spreadsheets.google.com/feeds/cells/" + c + "/" + (b.googleSpreadsheetWorksheet || "od6") + "/public/values?alt=json-in-script&callback=?", error: b.error, success: function (b) {
                    ...
                    for (k = 0; k < l; k++)
                        c = b[k], o = Math.max(o, c.gs$cell.col), n = Math.max(n, c.gs$cell.row);
                    for (k = 0; k < o; k++)
                        if (k >= i && k <= g)
                            f[k - i] = [], f[k - i].length = Math.min(n, d - e);
                    for (k = 0; k < l; k++)
                        if (c = b[k], h = c.gs$cell.row - 1, j = c.gs$cell.col - 1, j >= i && j <= g && h >= e && h <= d)
            ...
            for (var a = this.columns, b = this.rawColumns, c = a.length, f, e, d, i, g, h, j = [], l, m = this.chartOptions; c--; ) {
                ...
                for (l = (g = q(c, this.valueCount.xColumns) !== - 1) && m && m.xAxis && s(m.xAxis)[0].type === "category"; f--; )
                    if (e = j[f] || a[c][f], d = parseFloat(e), i = b[c][f] = this.trim(e), l)
                        a[c][f] = i;
                    else if (i == d)
                        a[c][f] = d, d > 31536E6 ?
                        ...
                        if (j[f] = e, a[c][f] = d, a[c].isDatetime = !0, a[c][f + 1] !== void 0) {
                            e = d > a[c][f + 1];
                            if (e !== h && h !== void 0)
                                this.alternativeFormat ? (this.dateFormat = this.alternativeFormat, f = a[c].length, this.alternativeFormat = this.dateFormats[this.dateFormat].alternative) : a[c].unsorted = !0;
                            h = e
                        }
                    } else if (a[c][f] = i === "" ? null : i, f !== 0 && (a[c].isDatetime || a[c].isNumeric))
                        a[c].mixed = !0;
                g && a[c].mixed && (a[c] = b[c])
            }
            if (a[0].isDatetime && h) {
            ...
            if (this.options.parsed)
                return this.options.parsed.call(this,
                        this.columns)
                ...
                if (b.hasOwnProperty("series"))
                    if (typeof b.series === "object")
                        for (d = Math.max(b.series.length,
                                e.series.length); d--; )
                            i = b.series[d] || {}, b.series[d] = g.merge(i, e.series[d]);
                    else
                        delete b.series;
                b = g.merge(e, b);
                a.call(f, b, c)
    ...
    l.prototype.populateColumns = function (a) {
        ...
        j(this.readers, function (b) {
            if (b.columnIndex === void 0)
                b.columnIndex = a.shift()
        });
    ...
    l.prototype.read = function (a, b) {
        ...
        if (this.name === void 0 && this.readers.length >= 2 && (e = this.getReferencedColumnIndexes(), e.length >= 2))
    ...
    l.prototype.hasReader = function (a) {
        ...
        for (b = 0; b < this.readers.length; b += 1)
            if (c = this.readers[b], c.configName === a)
                return!0
    }
})(Highcharts);
