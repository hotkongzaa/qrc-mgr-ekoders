...
$po_id = $_GET['po_id'];
$strBuilding = "";
$sqlSelectMemberAll = "select * from QRC_PO_IMAGE where temp_po_id like '$po_id'";
...
//    $strBuilding .= '<li class = "list-group-item"><img src="../images/uploads/' . $row['IMAGE_PATH'] . '" width="100px"/> <a href="#" onclick=delImage("' . $row['IMAGE_ID'] . '","' . $row['TEMP_PO_ID'] . '","' . $row['IMAGE_PATH'] . '")>ลบ (Delete)</a></li>';
    ...
    if ($strCheckType == "pdf") {
        $strBuilding .= '<li class = "list-group-item">'
                . '<img src="../images/pdf_icon.png" width="50px"/> <a href="#" onclick=delImage("' . $row['IMAGE_ID'] . '","' . $row['TEMP_PO_ID'] . '","' . $row['IMAGE_PATH'] . '")>ลบ (Delete)</a>'
                . '</li>';
    } else if ($strCheckType == "doc" || $strCheckType == "docx") {
        $strBuilding .= '<li class = "list-group-item">'
                . '<img src="../images/doc_icon.png" width="50px"/> <a href="#" onclick=delImage("' . $row['IMAGE_ID'] . '","' . $row['TEMP_PO_ID'] . '","' . $row['IMAGE_PATH'] . '")>ลบ (Delete)</a>'
                . '</li>';
    } else if ($strCheckType == "xls" || $strCheckType == "lsx") {
        $strBuilding .= '<li class = "list-group-item">'
                . '<img src="../images/xl_icons.png" width="50px"/> <a href="#" onclick=delImage("' . $row['IMAGE_ID'] . '","' . $row['TEMP_PO_ID'] . '","' . $row['IMAGE_PATH'] . '")>ลบ (Delete)</a>'
                . '</li>';
        ...
        $strBuilding .= '<li class = "list-group-item">'
                . '<img src="../images/file_icon.png" width="50px"/> <a href="#" onclick=delImage("' . $row['IMAGE_ID'] . '","' . $row['TEMP_PO_ID'] . '","' . $row['IMAGE_PATH'] . '")>ลบ (Delete)</a>'
                . '</li>';
    }
}
if ($strBuilding == "") {
